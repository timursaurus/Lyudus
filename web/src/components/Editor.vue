  ...
  <div class="container">
    ...
    <div v-if="editor">
        <div class='editor-tools'>
            <button title='Жирный | Bold' @click="editor.chain().focus().toggleBold().run()" :class="{ 'is-active': editor.isActive('bold') }" >
            ...
            <button title='Курсив | Italic' @click="editor.chain().focus().toggleItalic().run()" :class="{ 'is-active': editor.isActive('italic') }" >
            ...
            <button title='Зачеркивание | Strikethrough' @click="editor.chain().focus().toggleStrike().run()" :class="{ 'is-active': editor.isActive('strike') }" >
            ...
            <button title='Код | Code' @click="editor.chain().focus().toggleCode().run()" :class="{ 'is-active': editor.isActive('code') }">
        ...
        <div>
            <button title='Заголовок 1 | Heading 1' @click="editor.chain().focus().toggleHeading({ level: 1 }).run()" :class="{ 'is-active': editor.isActive('heading', { level: 1 }) }" >
            ...
            <button title='Заголовок 2 | Heading 2' @click="editor.chain().focus().toggleHeading({ level: 2 }).run()" :class="{ 'is-active': editor.isActive('heading', { level: 2 }) }" >
            ...
            <button title='Заголовок 3 | Heading 3' @click="editor.chain().focus().toggleHeading({ level: 3 }).run()" :class="{ 'is-active': editor.isActive('heading', { level: 3 }) }" >
            ...
            <button title='Параграф | Paragraph' @click="editor.chain().focus().setParagraph().run()" :class="{ 'is-active': editor.isActive('paragraph') }">
            ...
            <button title='Маркированный список | Bullet list' @click="editor.chain().focus().toggleBulletList().run()" :class="{ 'is-active': editor.isActive('bulletList') }">
            ...
            <button title='Упорядоченный список | Ordered list ' @click="editor.chain().focus().toggleOrderedList().run()" :class="{ 'is-active': editor.isActive('orderedList') }">
            ...
            <button title='Блок кода | Code block' @click="editor.chain().focus().toggleCodeBlock().run()" :class="{ 'is-active': editor.isActive('codeBlock') }">
        ...
        <div>
            <button title='Цитата | Blockquote' @click="editor.chain().focus().toggleBlockquote().run()" :class="{ 'is-active': editor.isActive('blockquote') }">
            ...
            <button title='Горизонтальный разделитель | Horizontal rule' @click="editor.chain().focus().setHorizontalRule().run()">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M2 11h2v2H2v-2zm4 0h12v2H6v-2zm14 0h2v2h-2v-2z"/></svg>
            </button>
        </div>
        <div>
            <button title='Следующая строка | Hard break' @click="editor.chain().focus().setHardBreak().run()">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/> <path d="M15 18h1.5a2.5 2.5 0 1 0 0-5H3v-2h13.5a4.5 4.5 0 1 1 0 9H15v2l-4-3 4-3v2zM3 4h18v2H3V4zm6 14v2H3v-2h6z" ></path> </svg>
            </button>
            <button title='Сбросить форматирование | Clear format' @click="editor.chain().focus().unsetAllMarks().run()">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12.651 14.065L11.605 20H9.574l1.35-7.661-7.41-7.41L4.93 3.515 20.485 19.07l-1.414 1.414-6.42-6.42zm-.878-6.535l.27-1.53h-1.8l-2-2H20v2h-5.927L13.5 9.257 11.773 7.53z"/></svg>
            </button>
        </div>
        <div>
            <button title='Отменить | Undo' @click="editor.chain().focus().undo().run()">
            ...
            <button title='Повторить | Redo' @click="editor.chain().focus().redo().run()">
